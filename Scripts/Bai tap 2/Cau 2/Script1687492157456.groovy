...
WebUI.verifyElementText(findTestObject('Object Repository/Bai Tap 2/Text/txt_required'), 'Required')

WebUI.clearText(findTestObject('Bai Tap 2/Text Field/txt_UserName'))
